...
from digitalhub_runtime_kfp.entities.task.build.entity import TaskKfpBuild
from digitalhub_runtime_kfp.entities.task.build.spec import TaskSpecKfpBuild, TaskValidatorKfpBuild
from digitalhub_runtime_kfp.entities.task.build.status import TaskStatusKfpBuild
